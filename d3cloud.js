...
d3.csv("word_freq.csv", function(error, data) {

  var categories = d3.keys(d3.nest().key(function(d) { return d.frequency; }).map(data));
    ...
    wordcloud.selectAll("text")
      ...
      .enter().append("text")
        ...
        .style("fill", function(d) {
            ...
            return color(paringObject[0].frequency);
        })
